...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--name', type=str, default="sign", help='Name of this trial')
        ...
        self.parser.add_argument('--dataset_name', type=str, default='sign', help='Dataset Name')
