...
import sys
sys.path.append("/root/MotionDiffuse/text2motion")
...
from datasets import Text2MotionDataset, SignDataset
...
if __name__ == '__main__':
    ...
    if opt.dataset_name == 't2m':
        ...
        opt.data_root = './data/Sign'
        opt.motion_dir = './data/Sign'
        opt.joints_num = 50
    ...
    train_dataset = SignDataset(opt, 'train')
