...
class SignDataset(data.Dataset):
    def __init__(self, opt, mode='train', w_vec=None):
        super().__init__()
        ...
        if self.mode == 'train':
            self.data_path = pjoin(opt.motion_dir, 'train.pkl')
        elif self.mode == 'dev':
            self.data_path = pjoin(opt.motion_dir, 'dev.pkl')
        else:
            self.data_path = pjoin(opt.motion_dir, 'test.pkl')
    ...
    def __getitem__(self, index):
        ...
        return text, gloss, motion, m_length
